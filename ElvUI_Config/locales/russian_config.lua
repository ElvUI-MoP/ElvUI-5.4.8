...
L["Main border color of the UI. |cffFF0000This is disabled if you are using the Thin Border Theme.|r"] = "Основной цвет окантовок. Опция отключена при использовании Thin Border Theme."
L["Media"] = "Медиа"
