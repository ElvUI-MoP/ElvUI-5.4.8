...
L["Core |cff00dd91E|r|cffe5e3e3lvUI|r options."] = "Основные опции |cff00dd91E|r|cffe5e3e3lvUI|r"
...
L["If enabled then the filter will only activate if the unit is casting not interruptible spells."] = "Если включено, то фильтр будет акитивирован, когда юнит произносит не прерываемое заклинание."
...
L["Over Power Threshold"] = "Более рначения ресурса"
