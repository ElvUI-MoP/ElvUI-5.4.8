...
--Bags
L["Add an item or search syntax to the ignored list. Items matching the search syntax will be ignored."] = "瘛餃銝芰祗瘜撅”泵祗瘜◤敹賜"
L["Add Item or Search Syntax"] = "瘛餃祗瘜"
...
L["RaidDebuff Indicator"] = "副本减益光环标示"
L["Range Check"] = "距离检查"
