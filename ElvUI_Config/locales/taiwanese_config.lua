...
L["Main border color of the UI. |cffFF0000This is disabled if you are using the Thin Border Theme.|r"] = "UI的主要邊框顏色.|cffFF0000如果你啟用細邊框主題這將被禁用|r"
L["Media"] = "材質"
...
L["Attach Text to Power"] = "文字附著於能量"
