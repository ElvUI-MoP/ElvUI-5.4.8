...
L["Display the castbar icon inside the castbar."] = "Afficher l'icone à l'intérieur de la barre d'incantation.";
...
L["Display the combat icon on the unitframe."] = "Afficher l'icône de combat sur les cadres d'unité"
L["Display the rested icon on the unitframe."] = "Afficher l'icône reposé sur les cadres d'unité"
...
L["Remove Spell ID or Name"] = "Supprimer l'identifiant ou le nom d'un sort"
...
L["Show For Tanks"] = "Voir poru les tanks"
