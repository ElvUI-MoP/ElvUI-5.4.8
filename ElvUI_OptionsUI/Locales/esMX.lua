...
L["Actions"] = "Acciones"
L["Add a spell to the filter. Use spell ID if you don't want to match all auras which share the same name."] = "Agrega un hechizo al filtro. Usa la ID de hechizo si no quieres hacer coincidir todas las auras que comparten el mismo nombre."
...
L["BINDING_HEADER_RAID_TARGET"] = "Marcadores de objetivo"
