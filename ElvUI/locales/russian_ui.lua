...
--*_MSG locales
L["LOGIN_MSG"] = "Добро пожаловать в %sElvUI|r версии %s%s|r. Если Вам нужна техническая поддержка, посетите наш форум на https://github.com/ElvUI-MoP"
...
L["Bandwidth"] = "Канал"
L["Bases Assaulted"] = "Баз атаковано"
L["Bases Defended"] = "Баз защищено"
...
L["DPS"] = "УВС"
L["Earned:"] = "Заработано"
L["Flags Captured"] = "Флагов захвачено"
L["Flags Returned"] = "Флагов возвращено"
L["Friends List"] = "Список друзей"
L["Friends"] = "Друзья" --Also in Skins
L["Gates Destroyed"] = "Ворот уничтожено"
L["Gold"] = "Золото"
L["goldabbrev"] = "|cffffd700з|r" --Also used in Bags
L["Graveyards Assaulted"] = "Кладбищ атаковано"
L["Graveyards Defended"] = "Кладбищ защищено"
L["Hit"] = "Метк."
