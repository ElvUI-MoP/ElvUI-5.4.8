...
L["You are now finished with the installation process. If you are in need of technical support please visit us at https://github.com/ElvUI-MoP"] = "설치 과정이 끝났습니다.|n궁금한 점 해결이나 기술지원이 필요하면 |cff2eb7e4https://github.com/ElvUI-MoP|r 를 방문하세요."
...
L["ElvUI is five or more revisions out of date. You can download the newest version from https://github.com/ElvUI-MoP"] = "현재 사용하는 ElvUI가 5버전 이상 뒤쳐진 버전입니다. https://github.com/ElvUI-MoP 에서 새 버전을 다운로드 받으세요."
L["ElvUI is out of date. You can download the newest version from https://github.com/ElvUI-MoP"] = "ElvUI가 오래된 버전입니다. https://github.com/ElvUI-MoP 에서 새 버전을 다운로드 받으세요."
...
L["For technical support visit us at https://github.com/ElvUI-MoP"] = "궁금한 사항이나 기술지원은 |cff2eb7e4https://github.com/ElvUI-MoP|r에서 해결하세요."
