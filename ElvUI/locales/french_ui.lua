...
--*_MSG locales
L["LOGIN_MSG"] = "Bienvenue sur %sElvUI|r version %s%s|r. Si vous avez besoin d'un support technique, vous pouvez nous rejoindre sur https://github.com/ElvUI-MoP"
...
L["You are now finished with the installation process. If you are in need of technical support please visit us at https://github.com/ElvUI-MoP"] = "Vous avez maintenant terminé le processus d'installation. Si vous avez besoin d'un support technique, merci de vous rendre sur https://github.com/ElvUI-MoP"
...
L["Level Up Display"] = "Affichage du gain de niveau"
...
L["ElvUI is five or more revisions out of date. You can download the newest version from https://github.com/ElvUI-MoP"] = "ElvUI est périmé d'au moins 5 versions. Vous pouvez télécharger la nouvelle version sur https://github.com/ElvUI-MoP"
L["ElvUI is out of date. You can download the newest version from https://github.com/ElvUI-MoP"] = "ElvUI est périmé. Vous pouvez télécharger la nouvelle version sur https://github.com/ElvUI-MoP"
...
L["For technical support visit us at https://github.com/ElvUI-MoP"] = "Pour tout support technique, merci de nous visiter à https://github.com/ElvUI-MoP"
