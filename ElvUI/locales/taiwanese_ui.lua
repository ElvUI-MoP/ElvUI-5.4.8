...
L["Carts Controlled"] = "車輛控制"
L["Character: "] = "角色: "
L["Combat Time"] = true;
L["copperabbrev"] = "|cffeda55f銅|r" --Also used in Bags
L["Deficit:"] = "赤字:"
L["Demolishers Destroyed"] = "石毀車摧毀"
L["Download"] = "下載"
L["DPS"] = "傷害輸出"
L["Earned:"] = "賺取:"
...
L["You are now finished with the installation process. If you are in need of technical support please visit us at https://github.com/ElvUI-MoP."] = "已完成安裝程序. 小提示: 若想開啟微型選單, 請在小地圖按滑鼠中鍵. 如果沒有中鍵按鈕, 請按住Shift鍵, 並在小地圖按滑鼠右鍵. 如需技術支援請至https://github.com/ElvUI-MoP"
...
L["Farm Mode"] = true;
L["Fishy Loot"] = "貪婪"
L["iLvl"] = "裝等" --Column header in raidbrowser
...
L["For technical support visit us at https://github.com/ElvUI-MoP."] = "如需技術支援請至 https://github.com/ElvUI-MoP."
