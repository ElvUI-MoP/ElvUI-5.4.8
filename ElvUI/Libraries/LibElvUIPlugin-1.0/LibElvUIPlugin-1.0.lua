...
------------------------------
local MSG_OUTDATED = "Your version of %s is out of date (latest is version %s). You can download the latest version from https://github.com/ElvUI-MoP"
...
if GetLocale() == "deDE" then
	MSG_OUTDATED = "Deine Version von %s ist veraltet (akutelle Version ist %s). Du kannst die aktuelle Version von https://github.com/ElvUI-MoP herunterrladen."
	HDR_CONFIG = "Plugins"
...
if GetLocale() == "ruRU" then
	MSG_OUTDATED = "Ваша версия %s устарела (последняя версия %s). Вы можете скачать последнюю версию на https://github.com/ElvUI-MoP"
	HDR_CONFIG = "Плагины"
