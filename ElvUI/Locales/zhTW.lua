...
L["Detected that your ElvUI OptionsUI addon is out of date. Not having your ElvUI OptionsUI addon up to date will result in missing options."] = "偵測到你的 ElvUI 設定插件已過期. ElvUI 設定插件過期會造成某些選項遺失"
...
L["Reset Counters: Hold Control + Right Click"] = "重置計數器: 按住 Ctrl + 右鍵點擊"
...
L["Show Talent Specialization UI"] = "顯示天賦專精介面"
