...
L["Detected that your ElvUI OptionsUI addon is out of date. Not having your ElvUI OptionsUI addon up to date will result in missing options."] = "Nous avons détecté que votre installation d'ElvUI est périmée. Ne pas avoir la version à jour ElvUI peut entrainer des erreurs."
...
L["ElvUI was updated while the game is still running. Please relaunch the game, as this is required for the files to be properly updated."] = "ElvUI a été mis à jour alors que le jeu est toujours en cours d'exécution. Veuillez relancer le jeu, car cela est nécessaire pour que les fichiers soient correctement mis à jour."
...
L["For technical support visit us at https://github.com/ElvUI-MoP."] = "Pour tout support technique, merci de nous rendre visite sur https://github.com/ElvUI-MoP"
L["Frame"] = "Fenêtre"
...
L["Reset Counters: Hold Control + Right Click"] = "Réinitialiser les compteurs: maintenez la touche Ctrl + clic droit"
