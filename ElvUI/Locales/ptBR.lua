...
L["(Shift Click) Collect Garbage"] = "(Shift Click) Coletar lixo"
...
L["Detected that your ElvUI OptionsUI addon is out of date. Not having your ElvUI OptionsUI addon up to date will result in missing options."] = true
...
L["Earned:"] = "Ganho:"
L["ElvUI Config"] = true
L["ElvUI has a dual spec feature which allows you to load different profiles based on your current spec on the fly. You can enable this from the profiles tab."] = "O ElvUI contém o modo de duas especializações, que permite que carregue perfis diferentes baseado na sua especialização atual rapidamente. Você pode ativar esta opção na guia Perfis."
L["ElvUI Installation"] = "Instalação do ElvUI"
L["ElvUI is five or more revisions out of date. You can download the newest version from https://github.com/ElvUI-MoP"] = "O ElvUI está rodando com cinco ou mais revisões desatualizadas. Você pode baixar a mais nova versão em https://github.com/ElvUI-MoP"
L["ElvUI is out of date. You can download the newest version from https://github.com/ElvUI-MoP"] = "O ElvUI está desatualizado. Você pode baixar a mais nova versão em https://github.com/ElvUI-MoP"
...
L["ElvUI was updated while the game is still running. Please relaunch the game, as this is required for the files to be properly updated."] = "ElvUI foi atualizado enquanto o jogo ainda estava rodando. Por favor reinicie o jogo, pois isto é requerido para os arquivos serem apropriadamente atualizados."
...
L["Level Up Display"] = "Display de Subida de Nível"
L["List of installations in queue:"] = "Lista de instalações na fila:"
L["Lock"] = "Travar"
L["LOGIN_MSG"] = ("Bem-vindo ao *ElvUI|r versão *%s|r, digite */ec|r para acessar as configurações dentro do jogo. Se você precisa de suporte técnico nos contate em https://github.com/ElvUI-MoP ou se entre no Discord: https://discord.gg/UXSc7nt"):gsub("*", COLOR1)
...
L["Reset Counters: Hold Control + Right Click"] = "Resetar contadores: Segurar CTRL + Clique Direito"
L["Reset Data: Hold Shift + Right Click"] = "Redefinir Dados: Segurar Shift + Clique Direito"
...
L["Show Talent Specialization UI"] = "Mostrar interface de especialização de talentos"
